...
// add welcome to console

console && console.log("%cWelcome to ZeroJS!\n%c如果你会Javascript、NodeJS, 并且乐意远程办公，欢迎加入我们 (pls email to admin@zerojs.io)", "font-size:1.5em;color:#00c8aa;", "color:#34465a;font-size:1em;");
